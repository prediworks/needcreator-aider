...
export const SETTINGS = {
  ...
  metaAccessToken: { key: 'metaAccessToken', type: 'text', group: 'Prospection', default: '', label: 'Jeton Meta (bibliothèque publicitaire), renouvelable ici', description: 'Jeton d\'accès prolongé (60 jours) avec l\'autorisation ads_read. Vide = valeur META_ACCESS_TOKEN du serveur. Rappel dans le tableau de bord admin 10 jours avant expiration.' },
};
