...
Réponds avec :
- intent : interested (veut en savoir plus, s'inscrire, discuter), question (pose une question précise), not_now (pas maintenant, plus tard), refusal (non), unsubscribe (demande de ne plus écrire), out_of_office (réponse automatique d'absence), other
- summary : une phrase
