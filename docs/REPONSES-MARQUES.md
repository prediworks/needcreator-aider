# Messages privés aux marques : ce qui se passe et quoi répondre

Constats des premiers envois Instagram (23 septembre 2026), à partir de quatre réponses réelles.

## Ce qu'il faut savoir avant d'écrire

- **Les marques lisent votre message comme une demande de collaboration venant d'un créateur.** C'est la boîte dans laquelle tombe tout message
...
Dans la file « À contacter aujourd'hui » ou sur la fiche du prospect (bouton « Réponse »). Collez le texte reçu :

- l'IA classe la réponse (intéressé, question, renvoie vers un autre canal, pas maintenant, refus) ;
- une adresse email donnée est **ajoutée à la fiche** : le prospect part alors par le mailing, avec la séquence marques ;
- un formulaire est noté sur la fiche ;
- un refus écarte le prospect, il ne sera plus recontacté.

## Quoi répondre, selon ce que dit la marque

| La marque écrit | Ce que ça veut dire | Quoi faire |
|---|---|---|
| « Écrivez-nous à influence@… » | porte ouverte, canal officiel | coller la réponse ; l'email part par le mailing. Répondre en DM une ligne : « Merci, je vous écris à cette adresse. » |
...
- Envoyer une liste d'avantages en message privé : ça confirme que vous êtes un vendeur.
- Relancer plus d'une fois en DM. Une marque qui n'a pas répondu à deux messages ne répondra pas au troisième, et Instagram le remarque.
- Envoyer un lien dans le premier message : il déclenche les filtres et fait perdre la confiance.

## Ce qui viendra avec les prochains chiffres

Notez pour chaque réponse : quelle case du tableau, et si vous avez obtenu une adresse. Dans une semaine, ces chiffres diront si le message
d'ouverture doit encore bouger.
