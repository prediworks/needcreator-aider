...
| Devis non retenu | Sélection d'un créateur quand tous les postes sont pourvus | Les autres candidats reçoivent une notification et un email court sans motif, avec un bloc « Augmentez vos chances » (portfolio, académie, Ambassadeur, devis) adapté à ce qu'il leur manque. Admin → Réglages → « Relances automatiques » : « Prévenir les créateurs non retenus » et « Proposer le programme Ambassadeur ». |
