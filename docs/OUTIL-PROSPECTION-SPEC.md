...
| **1. Extension interne** (première version livrée le 23/09/2026) | Extension et file de tâches, branchées sur NeedCreator ; types `read_post_author`, `read_profile`, `list_hashtag`, `list_ad_library` ; `prefill_message` reste à faire | Les deux routines hebdomadaires se font sans copier-coller |
