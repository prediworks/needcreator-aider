...
4 bis. **Traitement des réponses et onboarding automatique** (M, 2 jours) : email reçu classé par l'IA (intéressé, question, refus), réponse type proposée ; marque intéressée → compte pré-rempli et campagne d'amorçage créés seuls avec son vrai produit (devis dès le premier jour) ; créateur intéressé → lien d'inscription rattaché à sa fiche. Boucle d'apprentissage : taux d'inscription par message et par niche, textes ajustés. Tableau de bord : trouvés, contactés, inscrits, coût par inscrit.
