...
7. **Côté Meta, à faire par vous (16/09/2026)** : a) régénérer le jeton en cochant la page NeedCreator et son compte Instagram (la page a disparu des droits du jeton lors de la liaison), le coller dans Admin → Réglages → Prospection et dans le `.env` ; b) vérification d'identité personnelle (bibliothèque publicitaire, en cours) ; c) vérification de l'entreprise Prediworks SAS dans Business Manager (portefeuille → Centre de sécurité, Kbis ou avis SIRENE + facture), puis rattacher l'application « NeedCreator Prospection » au portefeuille : prérequis pour soumettre « oEmbed Read » (URL de test : une publication publique du compte Instagram NeedCreator) ; la même vérification servira à la publication automatique des campagnes et aux statistiques des créateurs connectés.
