...
| **TVA et facturation PDF** (règles décidées le 11 septembre 2026) | **Règles** : le créateur indique dans ses informations administratives s'il est assujetti à la TVA (franchise en base par défaut, sinon numéro de TVA intracommunautaire vérifié). Les devis sont saisis et affichés HT ; la marque paie TTC si le créateur est assujetti, HT sinon. Commission NeedCreator = 10 % du devis : 10 € HT + TVA (12 € TTC) pour un créateur assujetti, 10 € TTC (8,33 HT + 1,67 TVA) pour un créateur en franchise. Le prix du devis transite en compte de tiers, seul la commission est du chiffre d'affaires de PREDIWORKS (toujours avec TVA). **Documents** : facture du créateur à la marque émise par mandat de facturation (clause CGU + acceptation dans le profil, séquence par créateur, mention art. 293 B pour la franchise), facture de commission NeedCreator au créateur, factures NeedCreator à la marque pour Pro / gifting / pack, avoirs sur litige ou remplacement ; PDF stockés avec les contrats, page « Factures », relevé mensuel créateur. **À confirmer par l'expert-comptable avant de coder** : mandat de facturation et numérotation par créateur, flux en compte de tiers. Site à reformuler (« 90 % du devis » → 90 % HT pour les assujettis, 90 % pour la franchise) | M (2 jours) |
