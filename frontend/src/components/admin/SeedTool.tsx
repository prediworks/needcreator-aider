  ...
  return (
    <div className="space-y-6">
      <Card className="p-6">
        ...
        <p className="text-xs text-neutral-500 mt-1">Secteurs reconnus : beauté, e-commerce, food, tech, mode, services (autre mot = modèle au hasard). SIRET et site facultatifs. Tarif max : plafond du budget des campagnes de cette marque, 0 pour des campagnes « devis libre » sans budget affiché, vide pour la fourchette du lot ci-dessous. Avec l'IA configurée, chaque brief est rédigé par l'IA (produit inventé, format varié, sujets non répétés dans le lot) ; le commentaire facultatif est une consigne interne qu'elle respecte, jamais affichée (ex. « uniquement des applications et du service »). Sans IA, les modèles du secteur sont utilisés. Ligne commençant par # ignorée.</p>
      ...
      <Card className="p-6">
        ...
        <p className="text-sm text-neutral-600 mb-3">Les campagnes se créent en arrière-plan après la validation, rédigées par l&apos;IA{batches?.aiConfigured === false ? ' (IA non configurée sur ce serveur : modèles du secteur)' : ''}. Supprimer un lot retire ses campagnes et les devis reçus. « Avec les comptes » supprime aussi les marques du lot, dans la base et dans Firebase.</p>
