...
export default async function CreatorsPage() {
  ...
  const reasons: [any, string, string][] = [
    ...
    [Star, 'Devenez Ambassadeur', `Publiez une vidéo sur NeedCreator sur vos réseaux : votre commission passe à ${cfg.ambassadorFeePercent} % au lieu de ${cfg.platformFeePercent} %, vous voyez chaque campagne ${cfg.earlyAccessHours} h avant tout le monde, vos devis remontent en tête chez les marques et votre profil en tête de notre annuaire.`],
