...
export default function LoginPage() {
  ...
  const afterLogin = async () => {
    ...
    if (!user) {
      toast.info('Finalisez votre inscription pour continuer');
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      if (error.code === 'auth/unauthorized-domain') {
        toast.error('Ce domaine n\'est pas autorisé pour Google dans Firebase (Authentication → Settings → Authorized domains)');
      } else {
