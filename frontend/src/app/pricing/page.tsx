      ...
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-neutral-600">
            Pas d&apos;abonnement, pas de devis, pas de frais cachés. Vous payez la vidéo, nous prenons 10%.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-8">
          ...
          <Card className="p-8">
            ...
            <p className="text-neutral-600 mb-6">du prix accepté vous revient. Commission plateforme : 10%.</p>
            <ul className="space-y-2 text-sm text-neutral-700">
              {[
                'Inscription gratuite',
                'Vous fixez votre tarif minimum',
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="text-left text-neutral-500 border-b">
                  ...
                  <th className="py-2 pr-4">Prix payé par la marque</th>
                  <th className="py-2 pr-4">Commission (10%)</th>
