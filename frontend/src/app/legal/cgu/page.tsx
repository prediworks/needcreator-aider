  ...
  return (
    <LegalLayout title="Conditions générales d'utilisation">
      ...
      <ul>
        ...
        <li>Les campagnes « gifting » (produit offert sans rémunération) donnent lieu, pour les Marques sans abonnement Pro, à des frais de service de {F.giftingFeePerVideo} € HT par vidéo livrée, facturés à la Marque ; aucun frais de service n&apos;est dû par les Marques abonnées Pro.</li>
